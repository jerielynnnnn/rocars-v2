...
import {
  Shield, Lock, Key, Bell, User, Globe, Database,
  Activity, Clock, Eye, EyeOff, Save, RefreshCw,
  CheckCircle, AlertCircle, Loader2, ChevronRight,
  Server, HardDrive, LogOut, Smartphone, Mail, Phone,
  Fingerprint, QrCode, ShieldCheck, ShieldAlert,
  Info
} from 'lucide-react'
...
export default function AdminSettingsPage() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      // Try to get existing settings from user_profile_settings table
  ...
  const getSessionInfo = async () => {
    ...
    try {
      ...
      setSessionInfo(prev => ({ ...prev, ipAddress: data.ip }))
    } catch (error) {
      setSessionInfo(prev => ({ ...prev, ipAddress: 'Unknown' }))
    }
  }
  ...
  const handleLogoutAllDevices = async () => {
    if (confirm('⚠️ Warning: This will sign you out from all devices including this one. You will need to log in again. Continue?')) {
      try {
  ...
  const tabs = [
    ...
    { id: 'session', label: 'Session', icon: Clock, description: 'Session timeout and device management' },
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-gray-400">ID: {settings.admin_id?.slice(0, 8)}...</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                  settings.two_factor_enabled ? 'bg-black' : 'bg-gray-300'
                }`}
              >
            ...
            {settings.two_factor_enabled && (
              <div className="mt-4 p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 mb-2">Scan this QR code with Google Authenticator or any 2FA app</p>
            ...
            {settings.ip_whitelist_enabled && (
              <div className="mt-4">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  Your current IP: {sessionInfo.ipAddress}
                </p>
              </div>
            )}
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Session Configuration</h3>
                <p className="text-sm text-gray-500">Control session behavior and security</p>
              </div>
            </div>
              ...
              <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">Current Session (This Device)</p>
                    <p className="text-xs text-gray-500 truncate">{sessionInfo.userAgent}</p>
                    <p className="text-xs text-gray-500">IP: {sessionInfo.ipAddress}</p>
                  </div>
            ...
            <div className="mt-4 p-3 bg-yellow-50 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-yellow-700">
                  For security reasons, logging out from all devices will end all active sessions including this one.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
              ...
              <p className="text-sm text-gray-500">Last 10 admin actions</p>
            </div>
